if (global.keys_pressed.debug && global.debug.console) {
    ...
    ease_start(id, "height", enabled ? open_height : close_height, slide_time, slide_ease)
}
...
// only rebuild the suggestion when the typed text actually changed (you ACTUALLY changed!) 
if (input_string != autocomplete_source) {
    autocomplete_source = input_string
    autocomplete_match = ""
