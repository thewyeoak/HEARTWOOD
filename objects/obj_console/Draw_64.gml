...
var _prompt = "$ "
draw_set_colour(c_white)
//draw_formatted_text(_horizontal_padding, height - (_input_height - _vertical_padding), format_bubble, wrap_formatted_text(_prompt, char_limit, false))
draw_text(_horizontal_padding, height - (_input_height - _vertical_padding), wrap_formatted_text(_prompt, char_limit, false))
...
if (autocomplete_match != "") {
    ...
    //draw_formatted_text(_input_x, _input_y, format_bubble, wrap_formatted_text(autocomplete_match, char_limit, false))
...
//draw_formatted_text(_input_x, _input_y, format_bubble, wrap_formatted_text(input_string, char_limit, false))
...
for (var i = array_length(logs) - 1 - scroll_offset; i >= 0; i--) {
    ...
    // draw_formatted_text(_horizontal_padding, _log_y, format_bubble, logs[i].text)
